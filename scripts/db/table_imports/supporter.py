...
DATA_FILEPATH = "data/imports/cards/supporters.json"

def import_objects():
    """
    Import Supporter objects
    
    Process
        Step 1. Gather objects from the data file
        Step 2. Loop over each Supporter object and generate the records
            2a. Create and save a new Supporter record
            2b. Create relational records associated with this Supporter
    """
    print(f"""Importing Supporter objects from {DATA_FILEPATH}""")

    # STEP 1. Gather objects from the data file
    with open(DATA_FILEPATH, "r") as f:
        objects_to_import = json.loads(f.read())

    # STEP 2. Create each Supporter record individually
    for object_to_import in objects_to_import:
        # STEP 2a. Create and save a new Supporter record

        try:
            new_object = Supporter(
        ...
        # STEP 2b. Create relational (many-to-many) records associated with this Supporter
